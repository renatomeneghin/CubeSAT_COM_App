...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Bateria_imagem->setObjectName(QString::fromUtf8("Bateria_imagem"));

        gridLayout_7->addWidget(Bateria_imagem, 0, 0, 1, 1);

        EPS_Data = new QGroupBox(centralwidget);
        EPS_Data->setObjectName(QString::fromUtf8("EPS_Data"));
        ...
        Bat_mA_Acc->setObjectName(QString::fromUtf8("Bat_mA_Acc"));
        ...
        Protection_reg->setObjectName(QString::fromUtf8("Protection_reg"));
        ...
        Corrente_Bateria_2->setObjectName(QString::fromUtf8("Corrente_Bateria_2"));

        gridLayout_4->addWidget(Corrente_Bateria_2, 2, 0, 1, 1);

        Bat_mA_2 = new QLineEdit(scrollAreaWidgetContents_2);
        Bat_mA_2->setObjectName(QString::fromUtf8("Bat_mA_2"));
        ...
        Corrente_media_Bateria_2->setObjectName(QString::fromUtf8("Corrente_media_Bateria_2"));

        gridLayout_4->addWidget(Corrente_media_Bateria_2, 3, 0, 1, 1);

        Bat_mA_avg_2 = new QLineEdit(scrollAreaWidgetContents_2);
        Bat_mA_avg_2->setObjectName(QString::fromUtf8("Bat_mA_avg_2"));
        ...
        Bat_mA_Acc_2->setObjectName(QString::fromUtf8("Bat_mA_Acc_2"));
        ...
        Protection_reg_2->setObjectName(QString::fromUtf8("Protection_reg_2"));
        ...
        Corrente_Bateria_3->setObjectName(QString::fromUtf8("Corrente_Bateria_3"));

        gridLayout_6->addWidget(Corrente_Bateria_3, 2, 0, 1, 1);

        Bat_mA_3 = new QLineEdit(scrollAreaWidgetContents_3);
        Bat_mA_3->setObjectName(QString::fromUtf8("Bat_mA_3"));
        ...
        Corrente_media_Bateria_3->setObjectName(QString::fromUtf8("Corrente_media_Bateria_3"));

        gridLayout_6->addWidget(Corrente_media_Bateria_3, 3, 0, 1, 1);

        Bat_mA_avg_3 = new QLineEdit(scrollAreaWidgetContents_3);
        Bat_mA_avg_3->setObjectName(QString::fromUtf8("Bat_mA_avg_3"));
        ...
        Bat_mA_Acc_3->setObjectName(QString::fromUtf8("Bat_mA_Acc_3"));
        ...
        Protection_reg_3->setObjectName(QString::fromUtf8("Protection_reg_3"));
        ...
        Bateria_numero->setObjectName(QString::fromUtf8("Bateria_numero"));
        ...
        texto_Comando->setObjectName(QString::fromUtf8("texto_Comando"));

        horizontalLayout->addWidget(texto_Comando);

        Comando = new QLineEdit(verticalFrame_2);
        Comando->setObjectName(QString::fromUtf8("Comando"));
        ...
        Texto_Recebido->setObjectName(QString::fromUtf8("Texto_Recebido"));
